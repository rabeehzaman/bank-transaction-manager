...
console.log('\nNote: For PNG generation, you would need additional libraries like sharp or canvas.');
console.log('For now, using the SVG as the source. You can convert it to PNG using online tools or install dependencies.');